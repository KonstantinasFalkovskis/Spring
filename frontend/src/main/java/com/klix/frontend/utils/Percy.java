package com.klix.frontend.utils;
...
//        this.env = new Environment(driver);
     ...
     *
     */
    public void snapshot(String name) throws JSONException{
//        Thread.sleep(2000);
        snapshot(name, null, null, false, null, null);
    }

    public void snapshot(String name, String percyCSS) throws JSONException{
//        Thread.sleep(2000);
        snapshot(name, null, null, false, percyCSS, null);
    }
     ...
     *               pixels.
     */
    public void snapshot(String name, Integer widths[]) throws JSONException {
     ...
     */
    public void snapshot(String name, Integer widths[], Integer minHeight) throws JSONException {
     ...
     */
    public void snapshot(String name, Integer widths[], Integer minHeight, boolean enableJavaScript) throws JSONException {
     ...
     */
    public void snapshot(String name, Integer widths[], Integer minHeight, boolean enableJavaScript, String percyCSS) throws JSONException {
     ...
     */
    public void snapshot(String name, Integer widths[], Integer minHeight, boolean enableJavaScript, String percyCSS, String scope) throws JSONException {
...
//            domSnapshot = (Map<String, Object>) jse.executeScript(buildSnapshotJS(Boolean.toString(enableJavaScript)));
            jse.executeScript(buildSnapshotJS(Boolean.toString(enableJavaScript)));
        ...
        postSnapshot(name, widths, minHeight, driver.getCurrentUrl(), enableJavaScript, percyCSS, scope);
    }
